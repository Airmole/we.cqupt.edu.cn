...
module.exports = {
    ...
    module: {
        ...
        loaders: [{
            ...
            // 编译es2015 & react
            // run `npm install babel-loader babel-core babel-preset-es2015 babel-preset-react --save-dev` before
            test: /\.js$/, loader: 'babel', exclude: /node_modules/, query: { presets: ['es2015', 'react'] }
        },  {
            // sass将编译为css
            // run `SASS_BINARY_SITE=https://npm.taobao.org/mirrors/node-sass/ npm install style-loader css-loader sass-loader node-sass compass-mixins --save-dev` before (SASS_BINARY_SITE前缀可解决node-sass访问太慢的问题)
            ...
            // less将编译为css
            // run `npm install style-loader css-loader less-loader less --save-dev` before
